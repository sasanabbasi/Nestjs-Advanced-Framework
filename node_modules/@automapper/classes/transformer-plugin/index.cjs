...
function isNumberEnum(type) {
  ...
  return isEnum && ((_b = valueDeclaration === null || valueDeclaration === void 0 ? void 0 : valueDeclaration.members) === null || _b === void 0 ? void 0 : _b.some(member => member.initializer == null)) || false;
}
...
function getDecoratorOrUndefinedByNames(names, factory, decorators) {
  return (decorators || factory.createNodeArray()).find(item => names.includes(getDecoratorName(item)));
}
...
class ModelVisitor {
  ...
  static createMetadataFactoryMethod(factory, metadata) {
     ...
     * }
     */
    return factory.createMethodDeclaration(undefined, [factory.createModifier(tsserverlibrary.SyntaxKind.StaticKeyword)], undefined, factory.createIdentifier(classes.AUTOMAPPER_METADATA_FACTORY_KEY), undefined, undefined, [], undefined, factory.createBlock([factory.createReturnStatement(metadataAsReturnBlock)], true));
  }
